 ...
 */
void printing_upper_short(char *hex, int char_count)
{
	int i = 0;
 ...
 */
int length_upper_short(unsigned int num)
{
	int char_count = 0;
...
int short_upper_hex(unsigned short int num)
{
	...
	char_count = length_upper_short(num);
	...
	printing_upper_short(hex, char_count);
	free(hex);
	return (char_count);
}
